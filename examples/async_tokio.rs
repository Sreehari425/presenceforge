...
async fn main() -> Result {
    ...
    let client_id = args.client_id
        ...
        .unwrap_or_else(|| {
            ...
            eprintln!("  - Command line: cargo run --example async_tokio --features tokio-runtime -- --client-id YOUR_ID");
            eprintln!("  - Environment: DISCORD_CLIENT_ID=YOUR_ID cargo run --example async_tokio --features tokio-runtime");
