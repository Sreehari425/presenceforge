...
impl ActivityBuilder {
    ...
    pub fn start_timestamp(&mut self, timestamp: u64) -> &mut Self {
        self.get_timestamps().start = Some(timestamp);
        self
    }

    /// Set the end timestamp
    pub fn end_timestamp(&mut self, timestamp: i64) -> &mut Self {
        self.get_timestamps().end = Some(timestamp);
        self
    }

    /// Set the large image asset
    pub fn large_image<S: Into<String>>(&mut self, key: S) -> &mut Self {
        self.get_assets().large_image = Some(key.into());
        self
    }

    /// Set the large image text
    pub fn large_text<S: Into<String>>(&mut self, text: S) -> &mut Self {
        self.get_assets().large_text = Some(text.into());
        self
    }

    /// Set the small image asset
    pub fn small_image<S: Into<String>>(&mut self, key: S) -> &mut Self {
        self.get_assets().small_image = Some(key.into());
        self
    }

    /// Set the small image text
    pub fn small_text<S: Into<String>>(&mut self, text: S) -> &mut Self {
        self.get_assets().small_text = Some(text.into());
        self
    }

    /// Set party information
    pub fn party<S: Into<String>>(&mut self, id: S, current_size: u32, max_size: u32) -> &mut Self {
    ...
    pub fn button<L: Into<String>, U: Into<String>>(&mut self, label: L, url: U) -> &mut Self {
    ...
    pub fn join_secret<S: Into<String>>(&mut self, secret: S) -> &mut Self {
        self.get_secrets().join = Some(secret.into());
        self
    }

    pub fn spectate_secret<S: Into<String>>(&mut self, secret: S) -> &mut Self {
        self.get_secrets().spectate = Some(secret.into());
        self
    }

    pub fn match_secret<S: Into<String>>(&mut self, secret: S) -> &mut Self {
        self.get_secrets().match_secret = Some(secret.into());
        self
    }

    /// Set instance flag
    pub fn instance(&mut self, instance: bool) -> &mut Self {
